...
const ButtonLoginRegister = () => {
    ...
    return (
        <>
            {currentUser ? (
                <button
                    className="group absolute top-0 right-0 mx-6 my-6 cursor-pointer rounded-full border border-rose-700 bg-slate-100 px-2 py-4 hover:bg-rose-800 focus:outline-none focus:ring-1 focus:ring-rose-300"
                    onClick={logoutUser}
                >
